        ...
        <>
            <div className="light-donate-container">
                    ...
                    lightDonateData.map((data, index) => {
                        return (
                            <div className="light-donate-card" key={index}>
                                ...
                                <div className='light-donate-card-centre'><a href={data.link} target='_blank'>{data.centre}</a></div>
                ...
                <div className="light-donate-card">
                    ...
                    <div className='light-donate-card-centre'><a href='https://light.gyws.org/center_gwalior_thatipur' target='_blank'>LiGHT Gwalior Thatipur</a></div>
                    ...
                    <div className="text-center pay-btn">
                        <a href='https://gopali-youth-welfare-society.danamojo.org/dm/khel-ehsas-7108?utm_source=danamojo&utm_medium=share&utm_campaign=dmMicroSite' target='_blank'><img src="/images/donate.png" width={174} alt="" /></a>
                    </div>
                </div>
            </div>
        </>
